...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename=f"{sprites.Sprites.GAME_DIR}2DPower.log", filemode='w', format='%(asctime)s - %(levelname)s - %(message)s', datefmt='%d.%m.%Y %H:%M:%S', level=loglevel)
    game_state = status()
    bgm:mp3.Music = None
